  ...
  return (
    <footer className="bg-gradient-to-br from-[#0b1f3a] via-[#122d52] to-[#1d4073] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mx-2 sm:mx-4 md:mx-8 lg:mx-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/courses" className="transition-colors">Courses</Link></li>
              <li><Link href="/internship" className="transition-colors">Internship</Link></li>
            </ul>
          </div>
